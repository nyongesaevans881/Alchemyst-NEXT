          ...
          {showBio && (
            ...
            >
              <div className="flex flex-wrap items-center justify-center mb-2">
                {profile.services && profile.services.slice(0, 6).map((service, index) => (
                  <span className="bg-blue-400 text-white rounded-lg m-1 text-sm px-2" key={index}>{service.name}</span>
                ))}
              </div>
