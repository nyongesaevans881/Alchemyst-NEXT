...
export const useProfiles = () => {
  ...
  }, [dispatch, allProfiles.length, selectedCounty, router])

  // Set county, location, area from URL params (for location pages)
  // Note: In Next.js, params should be passed from the component that has access to them via the route
  // This code is preserved for reference but should be called from components instead
