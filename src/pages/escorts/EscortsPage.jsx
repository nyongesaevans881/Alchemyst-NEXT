...
export default function EscortsPage() {
  ...
  // Set userType to escort on mount
  useEffect(() => {
    if (filters.userType !== 'escort') {
      updateFilters({ ...filters, userType: 'escort' })
    }
  }, [])
        ...
        <div className="relative container mx-auto max-w-6xl">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-4">
            <h1 className="text-4xl md:text-5xl font-bold text-text-inverse mb-4 max-md:flex max-md:flex-col">
              Alchemyst
              <span className="bg-[url('/graphic/scratch.png')] bg-cover bg-center bg-no-repeat py-2 px-2"> escorts </span>
            </h1>
          </motion.div>
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <div className="flex items-center gap-4 text-sm text-muted-foreground">
              <span>{displayedCount} escorts found</span>
              {lastFetchTime && (
                <>
                  <span>•</span>
