...
export default function SettingsCard({ userData, updateUserData }) {
        ...
        <form onSubmit={handleEmailChange} className="space-y-4">
          ...
          <div className="bg-warning/10 border border-warning/30 rounded-lg p-4">
            ...
            <p className="text-text-muted text-sm">
              After changing your email, you will need to verify your new email address. 
              You will be logged out and will need to verify your new email before you can log in again.
            </p>
          </div>
